-- A1 module-owned initial schema, generated from the preserved Schema::createSql().
-- Existing tables and IDs are retained by IF NOT EXISTS; no destructive upgrade.
