...
namespace app\modules\official\reference_codes\Versioned\Application;
...
final class ReferenceCodeException extends RuntimeException
{
    ...
    {
        return new self('REFERENCE_CODE_REQUEST_IN_PROGRESS', 409, 'The reference-code request is still processing.');
    }
