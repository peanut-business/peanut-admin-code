...
namespace app\modules\official\task\job\Persistence;
...
use app\modules\official\task\job\Execution\JobClaim;
use app\modules\official\task\job\Persistence\Model\TaskJobAttemptRecord;
use app\modules\official\task\job\Persistence\Model\TaskJobEventRecord;
use app\modules\official\task\job\Persistence\Model\TaskJobRecord;
use Throwable;
...
final class TaskJobStore
{
    ...
    public function enqueue(
        ...
        try {
            ...
            if ($idempotencyKeyHash === null || !$this->isUniqueConflict($exception)) {
                throw $exception;
            }
