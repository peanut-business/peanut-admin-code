...
namespace app\modules\official\settings\Application;
...
use app\modules\official\settings\Model\DeploymentSettingValue;
use app\modules\official\settings\Model\SettingDefinitionRecord;
use app\modules\official\settings\Model\TargetSettingValue;
use app\modules\official\settings\Model\TenantSettingValue;
    ...
    private function storage(
        ...
        if ($definition->secret) {
            ...
            try {
                ...
                throw $exception->getMessage() === 'SETTING_SECRET_VALUE_INVALID'
                    ? SettingException::invalid('SETTING_VALUE_INVALID', 'A secret setting requires a non-empty bounded value.')
                    : SettingException::unavailable('SETTING_SECRET_UNAVAILABLE', 'The setting secret protector is unavailable.');
            }
