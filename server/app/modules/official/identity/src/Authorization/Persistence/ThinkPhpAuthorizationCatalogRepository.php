...
namespace PeanutAdmin\Modules\Identity\Authorization\Persistence;

use DomainException;
use JsonException;
use PeanutAdmin\Modules\Identity\Authorization\Model\DataConditionDefinitionRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\ProtectedResourceRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\ResourceOperationConditionRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\ResourceOperationPermissionRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\ResourceOperationRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\ResourceOperationTargetTypeRecord;
use PeanutAdmin\Modules\Identity\Authorization\Model\TargetTypeRecord;
use PeanutAdmin\Modules\Identity\Persistence\Model\Permission;
use think\Model;

final class ThinkPhpAuthorizationCatalogRepository implements \PeanutAdmin\Kernel\Authorization\Persistence\AuthorizationCatalogRepository
{
    public function syncPermission(\PeanutAdmin\Kernel\Authorization\Persistence\PermissionDefinition $definition): int
    {
    ...
    public function syncProtectedResource(\PeanutAdmin\Kernel\Authorization\Persistence\ProtectedResourceDefinition $definition): int
    {
    ...
    public function syncTargetType(\PeanutAdmin\Kernel\Authorization\Persistence\TargetTypeDefinition $definition): int
    {
    ...
    public function syncDataCondition(\PeanutAdmin\Kernel\Authorization\Persistence\DataConditionDefinition $definition): int
    {
        try {
    ...
    public function syncResourceOperation(\PeanutAdmin\Kernel\Authorization\Persistence\ResourceOperationDefinition $definition): int
    {
