-- Forward adoption of the existing business schema. Existing tables and data are preserved.

CREATE TABLE IF NOT EXISTS `pa_notification_template` (
...
CREATE TABLE IF NOT EXISTS `pa_notification_message` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pa_notification_attachment` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `tenant_id` BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pa_notification_outbox` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pa_sms_rate_bucket` (
  `tenant_id` BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pa_notification_event` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `tenant_id` BIGINT UNSIGNED NOT NULL,
  `message_id` BIGINT UNSIGNED NOT NULL,
