...
return [
    ...
    'components' => ['schemas' => [
        ...
        'IntegrationDelivery' => ['type' => 'object', 'additionalProperties' => true, 'required' => ['delivery_key', 'endpoint_key', 'event_type', 'status']],
        'IntegrationAttempt' => ['type' => 'object', 'additionalProperties' => true, 'required' => ['attempt_number', 'outcome', 'duration_ms', 'attempted_at']],
