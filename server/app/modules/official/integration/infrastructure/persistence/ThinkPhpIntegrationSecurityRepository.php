...
namespace app\modules\official\integration\infrastructure\persistence;
...
use app\modules\official\integration\application\WebhookAttemptRecord;
use app\modules\official\integration\application\WebhookDeliveryRecord;
use app\modules\official\integration\application\WebhookEndpoint;
use app\modules\official\integration\model\IntegrationMachineIdentityRecord;
use app\modules\official\integration\model\IntegrationSecurityEventRecord;
use app\modules\official\integration\model\IntegrationWebhookAttemptRecord;
use app\modules\official\integration\model\IntegrationWebhookDeliveryRecord;
use app\modules\official\integration\model\IntegrationWebhookEndpointRecord;
use app\modules\official\integration\webhook\TrustedWebhookEvent;
...
final readonly class ThinkPhpIntegrationSecurityRepository implements IntegrationSecurityRepository
{
    ...
    {
        $decoded = is_array($json)
            ? $json
            : json_decode($this->jsonText($json), true, 64, JSON_THROW_ON_ERROR);
