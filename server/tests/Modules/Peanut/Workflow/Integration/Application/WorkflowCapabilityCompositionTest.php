...
namespace PeanutAdmin\Modules\Workflow\Tests\Integration\Application;
...
use PeanutAdmin\Modules\Notification\Delivery\Application\AttachmentResolver as NotificationAttachmentResolver;
...
use PeanutAdmin\Modules\Workflow\Application\WorkflowRuntime;
use PeanutAdmin\Modules\Workflow\Database\Schema as WorkflowSchema;
use PeanutAdmin\Modules\Workflow\Package as WorkflowPackage;
...
final class WorkflowCapabilityCompositionTest extends DatabaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->app = new App(dirname(__DIR__, 6));
        $this->app->initialize();
