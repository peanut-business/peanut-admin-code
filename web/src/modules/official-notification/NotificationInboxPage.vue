...
const baseUrl = new URL(import.meta.env.VITE_API_BASE_URL || '/', window.location.origin).toString();
...
const runtime = createNotificationRuntime({
  transport: createNotificationFetchTransport({ baseUrl, fetch: authenticatedFetch }),
