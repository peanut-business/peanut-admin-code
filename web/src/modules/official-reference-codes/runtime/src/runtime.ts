...
export const REFERENCE_CODES_ROUTE_NAME = 'official.reference-codes.list' as const
export const REFERENCE_CODES_ROUTE_PATH = '/system/reference-codes' as const
export const REFERENCE_CODES_READ_PERMISSION = 'official.reference-codes.read' as const
export const REFERENCE_CODES_MANAGE_PERMISSION = 'official.reference-codes.manage' as const
export const REFERENCE_CODES_STORE_KEY = 'official.reference-codes.runtime' as const
