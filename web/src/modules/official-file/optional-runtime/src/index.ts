export const FILE_MEDIA_PACKAGE = '@peanut-admin/official-file/optional-runtime' as const
...
export type { FileAssetError, FileAssetRuntime, FileAssetRuntimeOptions, FileAssetState } from './runtime'
